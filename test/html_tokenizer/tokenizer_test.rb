...
module HtmlTokenizer
  class TokenizerTest < Minitest::Test
    ...
    def test_tokenize_complex_doctype
      ...
      assert_equal(
        [
          ...
          [:attribute_quoted_value, "-//W3C//DTD XHTML 1.0 Transitional//EN"],
          [:attribute_quoted_value_end, "\""],
          [:whitespace, " "],
          [:attribute_quoted_value_start, "\""],
          [:attribute_quoted_value, "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"],
          [:attribute_quoted_value_end, "\""],
          [:tag_end, ">"],
        ],
        tokenize(text),
    ...
    def test_tokenize_tag_name_ending_with_slash
      ...
      assert_equal(
        [[:tag_start, "<"], [:tag_name, "div"], [:solidus, "/"], [:attribute_name, "1"], [:tag_end, ">"]],
        result,
      )
    end
    ...
    def test_tokenize_unquoted_attributes_separated_with_solidus
      ...
      assert_equal(
        [
          ...
          [:attribute_name, "foo"],
          [:equal, "="],
          [:attribute_unquoted_value, "1/bar=2"],
          [:tag_end, ">"],
        ],
        result,
      )
    ...
    def test_tokenize_quoted_attributes_separated_with_solidus
      ...
      assert_equal(
        [
          ...
          [:equal, "="],
          [:attribute_quoted_value_start, "\""],
          [:attribute_quoted_value, "1"],
          [:attribute_quoted_value_end, "\""],
          [:solidus, "/"],
          [:attribute_name, "bar"],
          [:equal, "="],
          [:attribute_quoted_value_start, "\""],
          [:attribute_quoted_value, "2"],
          [:attribute_quoted_value_end, "\""],
          [:tag_end, ">"],
        ],
        result,
    ...
    def test_tokenize_multipart_unquoted_attribute
      ...
      assert_equal(
        [
          ...
          [:attribute_name, "foo"],
          [:equal, "="],
          [:attribute_unquoted_value, "bar"],
          [:attribute_unquoted_value, "baz"],
          [:tag_end, ">"],
        ],
        result,
      )
    ...
    def test_tokenize_tag_attribute_with_no_quotes
      ...
      assert_equal(
        [
          ...
          [:attribute_name, "foo"],
          [:equal, "="],
          [:attribute_unquoted_value, "bla"],
          [:whitespace, " "],
          [:attribute_name, "bar"],
          [:equal, "="],
          [:attribute_unquoted_value, "blo"],
          [:tag_end, ">"],
        ],
        result,
      )
    ...
    def test_tokenize_double_equals
      ...
      assert_equal(
        [
          ...
          [:attribute_name, "foo"],
          [:equal, "="],
          [:attribute_unquoted_value, "blabar=blo"],
          [:tag_end, ">"],
        ],
        result,
      )
    ...
    def test_tokenize_script_containing_html
      ...
      assert_equal(
        [
          ...
          [:equal, "="],
          [:attribute_quoted_value_start, "\""],
          [:attribute_quoted_value, "text/html"],
          [:attribute_quoted_value_end, "\""],
          [:tag_end, ">"],
          [:text, "foo "],
          [:text, "<b"],
    ...
    def test_end_of_tag_on_newline
      ...
      assert_equal(
        [
          ...
          [:tag_name, "div"],
          [:whitespace, " "],
          [:attribute_name, "define"],
          [:equal, "="],
          [:attribute_quoted_value_start, "\""],
          [:attribute_quoted_value, "{credential_96_credential1: new Shopify.ProviderCredentials()}"],
          [:attribute_quoted_value_end, "\""],
          [:whitespace, "\n                  "],
          [:tag_end, ">"],
        ],
    ...
    def test_tokenize_attribute_name_with_space_before_equal
      ...
      assert_equal(
        [
          ...
          [:equal, "="],
          [:attribute_quoted_value_start, "\""],
          [:attribute_quoted_value, "http://www.cra-arc.gc.ca/tx/bsnss/tpcs/gst-tps/menu-eng.html"],
          [:attribute_quoted_value_end, "\""],
          [:tag_end, ">"],
          [:text, "GST/HST"],
          [:tag_start, "<"],
